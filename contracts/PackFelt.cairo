...
#TODO: Implement a big number library to clean the code up 
...
@external 
func pack_50 {syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr} (
        num0 : felt, 
        num1 : felt,
        num2 : felt,
        num3 : felt,
    ...
    packedData.write(      t49 + t48 + t47 + t46 + t45 + t44 + t43 + t42 + t41 + 
...
@external 
func unpack_50 {syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, bitwise_ptr : BitwiseBuiltin*, range_check_ptr} (
    ) -> (
        num0 : felt, 
        num1 : felt,
        num2 : felt,
    ...
    # let (t49, _) = unsigned_div_rem(t49, SHIFT_50_20)
    # let (t49, _) = unsigned_div_rem(t49, SHIFT_50_20)   
    # let (num49, _) = unsigned_div_rem(t49, SHIFT_50_9) 
...
#to test how divide works, there is a limit of about 2**122 for the denominator so divisiors larger than this must be done in chunks.
@view
